export class DrLookup{
	...
	listDoctors(state, city, condition){
		$.get(`https://api.betterdoctor.com/2016-03-01/doctors?location=${state}-${city}&skip=0&limit=10&user_key=58eefaa257c26e003a35de37308e601f`).then(function(response){
